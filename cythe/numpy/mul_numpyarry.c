...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cythe.numpy.mul_numpyarry",
        "sources": [
            "cythe/numpy/mul_numpyarry.pyx",
            "src/mul_numpyarry.c"
        ]
    },
    "module_name": "cythe.numpy.mul_numpyarry"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cythe__numpy__mul_numpyarry
#define __PYX_HAVE_API__cythe__numpy__mul_numpyarry
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cythe.numpy.mul_numpyarry' */
__PYX_EXTERN_C DL_IMPORT(void) c_multiply(double *, double, int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "cythe.numpy.mul_numpyarry"
extern int __pyx_module_is_main_cythe__numpy__mul_numpyarry;
int __pyx_module_is_main_cythe__numpy__mul_numpyarry = 0;

/* Implementation of 'cythe.numpy.mul_numpyarry' */
...
static const char __pyx_k_cythe_numpy_mul_numpyarry[] = "cythe.numpy.mul_numpyarry";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_cythe_numpy_mul_numpyarry_pyx[] = "cythe/numpy/mul_numpyarry.pyx";
...
static PyObject *__pyx_n_s_cythe_numpy_mul_numpyarry;
static PyObject *__pyx_kp_s_cythe_numpy_mul_numpyarry_pyx;
...
static PyObject *__pyx_pf_5cythe_5numpy_13mul_numpyarry_multiply(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input, double __pyx_v_value); /* proto */
...
/* "cythe/numpy/mul_numpyarry.pyx":11
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5cythe_5numpy_13mul_numpyarry_1multiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5cythe_5numpy_13mul_numpyarry_multiply[] = "\n    Multiply a numpy array element-wise by a value in place. \n\n    Parameters:\n    ----------\n    * `array: [np.ndarray, type=np.float64, shape=(2,)\n        Array to be multiplied.\n \n    * `value`: [int or float]\n        Number to multiply eash element in the array by.\n    ";
static PyMethodDef __pyx_mdef_5cythe_5numpy_13mul_numpyarry_1multiply = {"multiply", (PyCFunction)__pyx_pw_5cythe_5numpy_13mul_numpyarry_1multiply, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5cythe_5numpy_13mul_numpyarry_multiply};
static PyObject *__pyx_pw_5cythe_5numpy_13mul_numpyarry_1multiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("multiply (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_value)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("multiply", 1, 2, 2, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "multiply") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_value = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_value == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("multiply", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cythe.numpy.mul_numpyarry.multiply", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_5cythe_5numpy_13mul_numpyarry_multiply(__pyx_self, __pyx_v_input, __pyx_v_value);
...
static PyObject *__pyx_pf_5cythe_5numpy_13mul_numpyarry_multiply(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input, double __pyx_v_value) {
  int __pyx_v_m;
  int __pyx_v_n;
  ...
  __pyx_pybuffernd_input.rcbuffer = &__pyx_pybuffer_input;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input.rcbuffer->pybuffer, (PyObject*)__pyx_v_input, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  /* "cythe/numpy/mul_numpyarry.pyx":25
 *     cdef int m, n
 * 
 ...
 *     return None
 */
  __pyx_t_1 = (__pyx_v_input->dimensions[0]);
  __pyx_t_2 = (__pyx_v_input->dimensions[1]);
  __pyx_v_m = __pyx_t_1;
  __pyx_v_n = __pyx_t_2;

  /* "cythe/numpy/mul_numpyarry.pyx":26
 * 
 *     m, n = input.shape[0], input.shape[1]
 *     c_multiply (&input[0,0], value, m, n)             # <<<<<<<<<<<<<<
 *     return None
 */
  ...
  __pyx_t_5 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_input.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_pybuffernd_input.diminfo[0].shape)) __pyx_t_5 = 0;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_input.diminfo[1].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 1;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_input.diminfo[1].shape)) __pyx_t_5 = 1;
  ...
  /* "cythe/numpy/mul_numpyarry.pyx":27
 *     m, n = input.shape[0], input.shape[1]
 *     c_multiply (&input[0,0], value, m, n)
 *     return None             # <<<<<<<<<<<<<<
 */
...
static int __pyx_pymod_exec_mul_numpyarry(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_mul_numpyarry},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cythe_numpy_mul_numpyarry, __pyx_k_cythe_numpy_mul_numpyarry, sizeof(__pyx_k_cythe_numpy_mul_numpyarry), 0, 0, 1, 1},
  {&__pyx_kp_s_cythe_numpy_mul_numpyarry_pyx, __pyx_k_cythe_numpy_mul_numpyarry_pyx, sizeof(__pyx_k_cythe_numpy_mul_numpyarry_pyx), 0, 0, 1, 0},
 ...
 *     Multiply a numpy array element-wise by a value in place.
 */
  __pyx_tuple__10 = PyTuple_Pack(4, __pyx_n_s_input, __pyx_n_s_value, __pyx_n_s_m, __pyx_n_s_n); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cythe_numpy_mul_numpyarry_pyx, __pyx_n_s_multiply, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmul_numpyarry(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmul_numpyarry(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_mul_numpyarry(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_mul_numpyarry(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_mul_numpyarry(PyObject *__pyx_pyinit_module) CYTHON_SMALL_CODE 
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_mul_numpyarry(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("mul_numpyarry", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cythe__numpy__mul_numpyarry) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cythe.numpy.mul_numpyarry")) {
      if (unlikely(PyDict_SetItemString(modules, "cythe.numpy.mul_numpyarry", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cythe/numpy/mul_numpyarry.pyx":3
 * import cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     Multiply a numpy array element-wise by a value in place.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5cythe_5numpy_13mul_numpyarry_1multiply, NULL, __pyx_n_s_cythe_numpy_mul_numpyarry); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_multiply, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cythe/numpy/mul_numpyarry.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cythe.numpy.mul_numpyarry", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cythe.numpy.mul_numpyarry");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
